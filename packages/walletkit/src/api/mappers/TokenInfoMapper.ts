...
export class TokenInfoMapper extends Mapper<JettonInfo, TokenInfo> {
    ...
    private extractImageFromNft(input: InternalTokenInfo): TokenImage | undefined {
    ...
    private extractAnimationFromNft(input: InternalTokenInfo): TokenAnimation | undefined {
